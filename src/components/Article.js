  ...
  renderComments() {
    if (this.props.isArticleView) {
      ...
      if (comments.length === 1) {
        ...
        return <span className="comments">{comments.length} Comments Count</span>;
      }
    } else {
      return <Link to={'/articles/' + this.props.article.id} className="comments">View Comments  Consatna</Link>;
    }
  }
